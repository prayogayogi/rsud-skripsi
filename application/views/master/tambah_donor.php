        ...
        <table class="table" id="table1">
          ...
          foreach ($pendonor as $data) : ?>
            <tr>
              ...
              <td> <a href="#" data-toggle="modal" data-target="#exampleModalEditDataPendonor<?= $data['id']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                <br><br>
                <a href="<?= base_url('dashboard/hapusDataPendonor/') . $data['id']; ?>" onclick=" return confirm('Anda Yakin Inggin Hapus..?')" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
              </td>
              <?php
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('dashboard/aksi_tambahdata') ?>" method="post">
                ...
                <div class="form-group">
                  <label for="tempat lahir">Tempat lahir</label>
                  <input type="text" name="tempat_tgl_lahir" id="tempat lahir" value="<?= $data['tempat_tgl_lahir'] ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label for="Tgl Lahir">Tgl Lahir</label>
                  <input type="date" name="tgl_lahir" id="Tgl Lahir" value="<?= $data['tgl_lahir'] ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label for="no hp">No Hp</label>
                ...
                <div class="form-group">
                  <label for="Berat Badan">Berat Badan</label>
                  <input type="number" name="berat_badan" id="Berat Badan" value="<?= $data['berat_badan'] ?>" class="form-control">
                </div>
                <button type="reset" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary">Save Data</button>
              </form>
